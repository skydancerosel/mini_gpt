...
backbone dominance and trajectory complexity.  These results support the
hypothesis that the backbone is optimizer-induced, emerging from second-moment
stabilization of cumulative update directions rather than instantaneous
gradient alignment or local curvature structure.
